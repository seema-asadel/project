 ...
 * @param next
 */
exports.validateUserAccessToken = (0, middleware_1.middleware)((req) => __awaiter(void 0, void 0, void 0, function* () {
    const token = req.token;
    if (!token) {
        throw statusError_1.StatusError.forbidden('');
    }
    const decodedData = yield index_1.userService
        .verifyUserToken(token, env_1.envs.jwt.accessToken.secret)
